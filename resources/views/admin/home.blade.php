    ...
    <div class="row p-4">
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
                ...
                <a href="/admin/Qlbaiviet/list" class="small-box-footer">Thêm thông tin <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
                ...
                <a href="/admin/users" class="small-box-footer">Thêm thông tin <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
