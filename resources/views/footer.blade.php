    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    <li class="p-b-10">
                        <a href="http://127.0.0.1:8000/danh-muc/17-cay-hoa.html" class="stext-107 cl7 hov-cl1 trans-04">
                            Cây Hoa
                        </a>
                    ...
                    <li class="p-b-10">
                        <a href="http://127.0.0.1:8000/danh-muc/16-rau-cu.html" class="stext-107 cl7 hov-cl1 trans-04">
                            Rau Củ
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="http://127.0.0.1:8000/danh-muc/15-cay-an-qua.html" class="stext-107 cl7 hov-cl1 trans-04">
                            Cây Ăn Quả
                        </a>
                    </li>
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    <li class="p-b-10">
                        <a href="http://127.0.0.1:8000/danh-muc/20-hat-giong.html" class="stext-107 cl7 hov-cl1 trans-04">
                            Hạt Giống
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="http://127.0.0.1:8000/danh-muc/19-phan-bon.html" class="stext-107 cl7 hov-cl1 trans-04">
                            Phân Bón
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="http://127.0.0.1:8000/danh-muc/18-dung-cu.html" class="stext-107 cl7 hov-cl1 trans-04">
                            Dụng Cụ
                        </a>
                    </li>
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <p class="stext-107 cl7 size-201">
                    Bạn có thắc mắc? Hãy liên hệ với chúng tôi qua địa chỉ: Số 08 Tôn Thất Thuyết Cầu Giấy, Hà Nội. Hoặc qua Email:
                    baitapnhom2@gmail.com
                </p>
        ...
        <div class="p-t-40">
            <div class="flex-c-m flex-w p-b-18">
                <a href="https://www.paypal.com/vn/home?locale.x=vi_VN" class="m-all-1">
                    <img src="template/images/icons/icon-pay-01.png" alt="ICON-PAY">
                </a>

                <a href="https://www.visa.com.vn/vi_VN/pay-with-visa/find-a-card/credit-cards.html" class="m-all-1">
                    <img src="template/images/icons/icon-pay-02.png" alt="ICON-PAY">
                </a>

                <a href="https://www.mastercard.com.vn/vi-vn.html" class="m-all-1">
                    <img src="template/images/icons/icon-pay-03.png" alt="ICON-PAY">
                </a>

                <a href="https://momo.vn" class="m-all-1">
                    <img src="template/images/icons/icon-pay-04.png" alt="ICON-PAY">
                </a>

                <a href="https://zalopay.vn" class="m-all-1">
