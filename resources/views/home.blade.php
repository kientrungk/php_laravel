                ...
                <div id="featuring" class="col-md-8">
                    <div class="row">
                        <div id="gardengeneralposts-12"
                            ...
                            <div id="theothers" class="">
                                <div id="widget-title-f" class="widget-title-home"><h3>Nổi Bật </h3></div>
                    ...
                    <div class="homersidebar desktophide col-md-4">
                        <div class="homesideexplore homesides">
                            <div class="insideit">
                                <div class="tltwbg">
                                    ...
                                    <div class="seaweed">Khám Phá</div>
                                    <div class="bgr hbg"></div>
                                </div>
                                <p><b>Bạn có biết</b>? Website của chúng tôi liên kết với các trang nhà vườn khác như: <a
                                        href="https://www.bachhoaxanh.com" target="_blank">bachhoaxanh</a> và <a
                                        href="https://nongnghieppho.vn" target="blank">nongnghieppho.vn</a> để giúp nâng cao trải nghiệm của bạn.</p>
                            </div>
                        </div>
                        ...
                        <div class="askapro homesides">
                            <div class="insideit">
                                <div class="tilte seaweed">Hỏi Chuyên Gia</div>
                                <p>Bạn có thắc mắc,<br/>Các chuyên gia chúng tôi<br/>có câu trả lời.</p>
                                <a class="newgenbtn inblock" href="http://127.0.0.1:8000/contact"
                                   target="_blank">
                    ...
                    <div class="">
                        <div id="gardengeneralposts-7" class="widget-wrapper widget_gardengeneralposts">
                            <div id="poparticulates" class="">
                                <div id="widget-title-three" class="widget-title-home"><h3>Bài Viết</h3></div>
                ...
                <div class="col-12">
                    <div id="gardengeneralposts-2" class="widget-wrapper widget_gardengeneralposts">
                        <div id="gardhomenewest">
                            <div id="widget-title-one" class="widget-title-home"><h3>Bài Viết Gần Đây</h3></div>
                            @php
